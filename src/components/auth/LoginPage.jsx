        ...
        <div style={{
            ...
            <div className="glass-panel" style={{
                ...
                <div style={{ marginBottom: '2rem' }}>
                    <Music size={48} style={{ color: 'var(--accent-primary)', marginBottom: '1rem' }} />
                    <h1 style={{ fontSize: '1.75rem', fontWeight: 'bold' }}>
                        LearningOn<span style={{ color: 'var(--accent-primary)' }}>Guitar</span>
                    </h1>
                    <p className="text-muted" style={{ marginTop: '0.5rem' }}>
                        Gérez vos partitions et accords
                    </p>
                </div>
                ...
                <div style={{
                    ...
                    <span style={{ fontSize: '0.875rem' }}>ou</span>
                    <div style={{ flex: 1, height: '1px', background: 'rgba(255,255,255,0.1)' }} />
                </div>
